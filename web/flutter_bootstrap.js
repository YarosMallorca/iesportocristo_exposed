        ...
        e.renderer === "skwasm"
          ? (u = (async () => {
              ...
              return (
                ...
                { skwasm: m.wasmExports, skwasmWrapper: m, ffi: { memory: m.wasmMemory } }
              );
            })())
          : (u = {});
...
Read more: https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts`)),
    ...
    async _getNewServiceWorker(e, n) {
      ...
      if (e.active.scriptURL.endsWith(n)) return console.debug("Loading from existing service worker."), e.active;
      {
  ...
  var g = class {
    ...
    async load({ serviceWorkerSettings: e, onEntrypointLoaded: n, nonce: r, config: t } = {}) {
      ...
      if (!i) throw "FlutterLoader.load requires _flutter.buildConfig to be set";
      let s = (l) => {
          switch (l) {
            case "skwasm":
        ...
        a = (l) =>
          (l.compileTarget === "dart2wasm" && !p.supportsWasmGC) || (t.renderer && t.renderer != l.renderer)
            ? !1
            : s(l.renderer),
        d = i.builds.find(a);
      if (!d) throw "FlutterLoader could not find a build compatible with configuration and environment.";
      let c = {};
      (c.flutterTT = new v()),
        e &&
...
_flutter.buildConfig = {
  ...
  builds: [{ compileTarget: "dart2js", renderer: "auto", mainJsPath: "main.dart.js" }],
};
...
_flutter.loader.load({
  ...
  serviceWorkerSettings: {
    serviceWorkerVersion: "557136314",
  },
});
